...
\authorrunning{Samuel Sze et al.}
...
\begin{figure}[tb]
	\begin{center}
  		\includegraphics[width=.26\columnwidth, clip, trim=0 0ex 0ex 0ex]{images/hsr_grasping.jpg}
  		\includegraphics[width=.3\columnwidth, clip, trim=0 0ex 0ex 30ex]{images/robocup_team.jpg}
    	\includegraphics[width=.305\columnwidth, clip, trim=0 0ex 0ex 15ex]{images/robocup2022.jpg}
	\end{center} 
	\caption{\emph{Left:} Team ORIon's HSR grasping a plant at the World Robot Summit (WRS) 2018 in Tokyo, Japan. \emph{Middle:} Team ORIon at RoboCup@Home 2019 in Sydney, Australia. \emph{Right:} Team ORIon at RoboCup@Home 2022 in Bangkok, Thailand.}
...
\begin{figure}[tb]
	\begin{center}
		...
		\includegraphics[width=.2225\columnwidth, clip, trim=0ex 0ex 0ex 0ex]{images/engsci2022.jpg}
	\end{center} 
	\caption{\emph{Left:} Team ORIon demonstrating the HSR to the public at the 2021 Goodwood Festival of Speed. \emph{Middle:} Demonstrating the HSR for HRH Prince William. \emph{Right:} Demonstrating HSR at Dept. of Engineering Science Open day 2022.}
	\label{fig:outreach}
\end{figure}
...
\begin{figure*}[!ht]
	\centering
	\subfigure{\resizebox{0.5\textwidth}{!}{\includegraphics{images/orion_overall.jpg}}}
	\vspace{-10pt}%
...
\begin{figure*}[!ht]
	\centering
	\subfigure{\resizebox{0.60\textwidth}{!}{\includegraphics{images/manipulation_data_flow.pdf}}}
	\vspace{-10pt}%
