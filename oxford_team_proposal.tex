...
% - Semantic search
% - Ethical Black Box Human-Robot Dialogue project
% - (Visual) Human detector/recognition system
% - Offine speech recognition: PocketSphinx and Wavenet
% - Levenstein distance with candidate texts
% - Semantic robustness to the speech classification by using WordNet (identifying synonymous words during the classification step
