...
Given the similarity of the HSR to the SCITOS platform, and other platforms the team are familiar with (e.g. through Lars Kunze's work on the PR2 for object search in a multi-story building~\cite{kunze12objsearch}\footnote{\url{https://www.youtube.com/watch?v=RIYRQC2iBp0}}), we predict that porting the
...
experience, in a range of service tasks, similar to the DSPL. Being selected
for the Toyota HSR will allow us to demonstrate our DSPL system at the qualification round in February 2018 and compete in RoboCup 2018 in Montreal.
